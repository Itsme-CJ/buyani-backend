...
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'public' AND TABLE_NAME = 'store' AND COLUMN_NAME IN ('account_number', 'account_name', 'qr_code');
